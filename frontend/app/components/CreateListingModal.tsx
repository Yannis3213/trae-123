  ...
  const handleSubmit = async () => {
    ...
    try {
      await createListing({
        ...
        missing_evidence_reason: form.has_listing_evidence
          ? ''
          : form.missing_evidence_reason,
      })
      onCreated()
      onClose()
    } catch (e) {
            ...
            >
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    update('has_listing_evidence', e.target.checked)
                  }
                />
                <span className="toggle-slider" />
              </label>
              <span style={{ fontWeight: 400 }}>
                {form.has_listing_evidence ? '是' : '否'}
              </span>
            </label>
          </div>
          {!form.has_listing_evidence && (
            <div className="form-group">
              ...
              <textarea
                ...
                onChange={(e) =>
                  update('missing_evidence_reason', e.target.value)
                }
