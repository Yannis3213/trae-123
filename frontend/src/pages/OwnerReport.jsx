...
const OwnerReport = (props) => {
  ...
  return (
    <div>
      ...
      <div class="card">
        <h3 class="section-title">录入业主报修信息</h3>

        <div class="detail-grid">
          <div class="detail-field">
            <label>报修标题 *</label>
            <input
              placeholder="如：1号楼3单元电梯异响"
              value={form().title}
