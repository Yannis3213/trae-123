...
func seedAuditNotes(tx *sql.Tx) error {
	...
	notes := []struct {
		...
		{o1, "待派发", "登记员张登记发起入职办理单，等待提交，可上传身份证/学历/离职证明", regID, "张登记"},

		{o2, "待派发", "登记员赵登记发起入职办理单，入职资料节点", reg2ID, "赵登记"},
		{o2, "处理中", "资料齐全已提交至合同审核节点，李审核认领，临期2天需尽快办理", audID, "李审核"},

		{o3, "待派发", "登记员张登记发起入职办理单", regID, "张登记"},
		{o3, "处理中", "合同签署已逾期3天，已通知HRBP负责人跟进，合同逾期影响入职", audID, "李审核"},
		{o3, "处理中", "复核负责人王复核已认领，正在处理账号开通，需注意逾期异常", revID, "王复核"},

		{o4, "待派发", "登记员赵登记初次提交入职资料（仅上传身份证，缺学历+离职证明）", reg2ID, "赵登记"},
		{o4, "处理中", "李审核已接手审核，发现缺离职证明和学历证书", audID, "李审核"},
		{o4, "处理中", "退回补正，需登记员补充学历证书和离职证明后重新提交", audID, "李审核"},

		{o5, "待派发", "登记员张登记发起入职办理单，入职资料完整", regID, "张登记"},
		{o5, "处理中", "合同审核通过，流转至账号开通节点", audID, "李审核"},
		{o5, "已关闭", "三节点全部通过，已完成入职办理归档", revID, "王复核"},

		{o6, "待派发", "登记员赵登记发起入职办理单", reg2ID, "赵登记"},
		{o6, "处理中", "候选人来电表示放弃入职，申请关闭单据", audID, "李审核"},
		{o6, "已关闭", "复核确认，手动关闭单据，标注候选人放弃入职", revID, "王复核"},

		{o7, "待派发", "登记员张登记提交入职资料，流转至合同签署节点，待审核主管认领", regID, "张登记"},

		{o8, "待派发", "登记员赵登记提交入职资料并通过合同审核", reg2ID, "赵登记"},
		{o8, "处理中", "合同审核通过，流转至账号开通节点，待复核负责人认领，临期1天", audID, "李审核"},
	}
