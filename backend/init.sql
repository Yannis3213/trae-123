...
('app003', 'RZ202506003', 'XS202506003', '北方物流股份', 8000000.00, 20, 'pending_correction', 'u1', 'verify_rejected', 5, 'u1', 'pending', 'pending', '退回补正样例-风控审核退回-第二次补正中', datetime('now', '-1 days'), 2),
...
('evr006', 'app003', 'invoice', '增值税发票', 1, 0, NULL, 'auditor', datetime('now', '-1 day'), '退回补正：金额不匹配，客户已补开部分发票'),
...
INSERT OR IGNORE INTO processing_records (id, application_id, from_status, to_status, from_node, to_node, action, handler, handler_role, acting_role, comment, correction_note, evidence_required, evidence_provided, evidence_changes, evidence_remarks, invoice_status_before, invoice_status_after, loan_status_before, loan_status_after, version_before, version_after) VALUES
('rec001', 'app001', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, 'contract,invoice', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec002', 'app001', 'draft', 'pending_verify', 'register', 'register_done', 'submit', 'u1', 'register', 'register', '提交核验', NULL, 'contract,invoice', 'contract,invoice', NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 2),
('rec003', 'app002', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, 'contract,invoice', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec004', 'app002', 'draft', 'pending_verify', 'register', 'register_done', 'submit', 'u1', 'register', 'register', '提交核验-材料不全', NULL, 'contract,invoice', 'contract', NULL, NULL, 'pending', 'failed', NULL, 'pending', 1, 2),
('rec005', 'app003', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, 'contract,invoice', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec006', 'app003', 'pending_verify', 'pending_correction', 'register_done', 'verify_rejected', 'reject', 'u2', 'auditor', 'auditor', '材料不符合要求，第一次退回补正', '合同金额800万与发票金额680万不匹配，相差15%',
 'contract,invoice', 'contract', NULL, NULL, 'pending', 'pending', NULL, 'pending', 2, 3),
('rec007', 'app003', 'pending_correction', 'pending_verify', 'verify_rejected', 'register_done', 'resubmit', 'u1', 'register', 'register', '第一次补正提交，已补充12张发票', NULL,
 'contract,invoice', 'contract,invoice', '+增值税发票,增值税专用发票_01-12', '增值税发票:已补开800万金额发票，分12张开具', NULL, 'pending', NULL, 'pending', 3, 4),
('rec008', 'app003', 'pending_verify', 'pending_correction', 'register_done', 'verify_rejected', 'reject', 'u2', 'auditor', 'auditor', '第二次退回补正-发票金额仍不足', '发票金额合计720万，仍差80万，请补足剩余发票',
 'contract,invoice', 'contract,invoice', NULL, NULL, 'pending', 'pending', NULL, 'pending', 4, 5),
('rec009', 'app004', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec010', 'app004', 'draft', 'pending_verify', 'register', 'register_done', 'submit', 'u1', 'register', 'register', '提交核验-已逾期', NULL, NULL, NULL, NULL, NULL, 'pending', 'pending', NULL, 'pending', 1, 2),
('rec011', 'app005', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec012', 'app005', 'pending_verify', 'verify_passed', 'register_done', 'verify_done', 'pass', 'u2', 'auditor', 'auditor', '核验通过，提交复核', NULL, 'contract,invoice_list', 'contract,invoice_list', NULL, NULL, 'pending', 'passed', NULL, 'pending', 1, 2),
('rec013', 'app006', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec014', 'app006', 'pending_verify', 'verify_passed', 'register_done', 'verify_done', 'pass', 'u2', 'auditor', 'auditor', '核验通过', NULL, 'contract,invoice', 'contract,invoice', NULL, NULL, 'pending', 'passed', NULL, 'pending', 1, 2),
('rec015', 'app006', 'verify_passed', 'pending_correction', 'verify_done', 'review_returned', 'return', 'u3', 'reviewer', 'reviewer', '复核退回：材料需重新核对', '发票日期与合同日期不一致',
 'contract,invoice,loan_voucher', 'contract,invoice', NULL, NULL, 'passed', 'passed', NULL, 'pending', 2, 3),
('rec016', 'app006', 'pending_correction', 'verify_passed', 'review_returned', 'verify_done', 'resubmit', 'u1', 'register', 'register', '重新提交复核，已更正发票日期', NULL,
 'contract,invoice,loan_voucher', 'contract,invoice,loan_voucher', '+loan_voucher,发票日期更正', '发票:已重新开具正确日期发票', NULL, 'passed', NULL, 'pending', 3, 4),
('rec017', 'app006', 'verify_passed', 'archived', 'verify_done', 'review_done', 'archive', 'u3', 'reviewer', 'reviewer', '复核通过，已归档', NULL, NULL, NULL, NULL, NULL, 'passed', 'passed', 'pending', 'confirmed', 4, 4),
('rec018', 'app007', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec019', 'app007', 'pending_verify', 'verify_passed', 'register_done', 'verify_done', 'pass', 'u2', 'auditor', 'auditor', '核验通过', NULL, 'contract,invoice', 'contract,invoice', NULL, NULL, 'pending', 'passed', NULL, 'pending', 1, 2),
('rec020', 'app007', 'verify_passed', 'pending_correction', 'verify_done', 'review_returned', 'return', 'u3', 'reviewer', 'reviewer', '复核退回补正', '发票号码有误，需重新核对',
 'contract,invoice', 'contract,invoice', NULL, NULL, 'passed', 'passed', NULL, 'pending', 2, 3);
...
('note002', 'app003', '第一次退回：合同金额800万与发票金额680万不匹配', 'exception', 'rec006', 'exc002', 'u2', 'auditor'),
('note003', 'app003', '登记员第一次补正提交，已补充12张增值税专用发票', 'correction', 'rec007', 'exc002', 'u1', 'register'),
('note004', 'app003', '第二次退回：发票金额合计720万仍差80万，需继续补足', 'exception', 'rec008', 'exc007', 'u2', 'auditor'),
('note005', 'app004', '已电话联系客户催办，客户表示明天提交', 'followup', NULL, NULL, 'u2', 'auditor'),
('note006', 'app006', '第一次复核退回原因：发票日期与合同日期差3天', 'exception', 'rec015', 'exc005', 'u3', 'reviewer'),
('note007', 'app007', '复核退回：发票编号INV-2025-06-011号码重复', 'exception', 'rec020', 'exc006', 'u3', 'reviewer');
...
('exc002', 'app003', 'rec006', 'note002', 'reject_correction', '第一次退回：合同金额800万与发票金额680万不匹配，相差15%', 'warning', 'auditor', 1, 'u1', 'register', '已补充12张增值税专用发票，金额合计720万'),
('exc003', 'app004', NULL, 'note005', 'overdue', '融资申请登记节点超时，已逾期3天，责任人为李审核（u2）', 'error', 'system', 0, NULL, NULL, NULL),
('exc004', 'app001', NULL, NULL, 'invoice_verify_pending', '发票核验尚未完成，当前待核验12张发票', 'warning', 'system', 0, NULL, NULL, NULL),
('exc005', 'app006', 'rec015', 'note006', 'review_return', '第一次复核退回：发票日期与合同日期不一致', 'warning', 'reviewer', 1, 'u1', 'register', '客户已更换新发票'),
('exc006', 'app007', 'rec020', 'note007', 'review_return', '复核退回：发票号码重复，疑似虚假发票嫌疑', 'error', 'reviewer', 0, NULL, NULL, NULL),
('exc007', 'app003', 'rec008', 'note004', 'reject_correction', '第二次退回：发票金额合计720万，仍差80万，请补足剩余发票', 'warning', 'auditor', 0, NULL, NULL, NULL);
