...
('rec007', 'app003', 'pending_correction', 'pending_verify', 'verify_rejected', 'register_done', 'resubmit', 'u1', 'register', 'register', '第一次补正提交，已补充12张发票', NULL,
 'contract,invoice', 'contract,增值税专用发票_01-12', NULL, 'pending', NULL, 'pending', 3, 4),
('rec008', 'app003', 'pending_verify', 'pending_correction', 'register_done', 'verify_rejected', 'reject', 'u2', 'auditor', 'auditor', '第二次退回补正-发票金额仍不足', '发票金额合计720万，仍差80万，请补足剩余发票',
 'contract,invoice', 'contract,增值税专用发票_01-12', 'pending', 'pending', NULL, 'pending', 4, 5),
('rec009', 'app004', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec010', 'app004', 'draft', 'pending_verify', 'register', 'register_done', 'submit', 'u1', 'register', 'register', '提交核验-已逾期', NULL, NULL, NULL, 'pending', 'pending', NULL, 'pending', 1, 2),
('rec011', 'app005', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec012', 'app005', 'pending_verify', 'verify_passed', 'register_done', 'verify_done', 'pass', 'u2', 'auditor', 'auditor', '核验通过，提交复核', NULL, 'contract,invoice_list', 'contract,invoice_list', 'pending', 'passed', NULL, 'pending', 1, 2),
('rec013', 'app006', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec014', 'app006', 'pending_verify', 'verify_passed', 'register_done', 'verify_done', 'pass', 'u2', 'auditor', 'auditor', '核验通过', NULL, 'contract,invoice', 'contract,invoice', 'pending', 'passed', NULL, 'pending', 1, 2),
...
('rec016', 'app006', 'pending_correction', 'verify_passed', 'review_returned', 'verify_done', 'resubmit', 'u1', 'register', 'register', '重新提交复核', NULL, NULL, 'contract,invoice,loan_voucher', NULL, 'passed', NULL, 'pending', 3, 4),
('rec017', 'app006', 'verify_passed', 'archived', 'verify_done', 'review_done', 'archive', 'u3', 'reviewer', 'reviewer', '复核通过，已归档', NULL, NULL, NULL, 'passed', 'passed', 'pending', 'confirmed', 4, 4),
('rec018', 'app007', NULL, 'pending_verify', NULL, 'register_done', 'create', 'u1', 'register', 'register', '创建融资申请单', NULL, NULL, NULL, NULL, 'pending', NULL, 'pending', 1, 1),
('rec019', 'app007', 'pending_verify', 'verify_passed', 'register_done', 'verify_done', 'pass', 'u2', 'auditor', 'auditor', '核验通过', NULL, 'contract,invoice', 'contract,invoice', 'pending', 'passed', NULL, 'pending', 1, 2),
