...
export const ACTION_MATRIX = {
  [ROLES.TRIAGE_NURSE]: {
    [STATUS.DRAFT]: [ACTIONS.EDIT, ACTIONS.SUBMIT],
    [STATUS.PENDING_SUBMIT]: [],
    [STATUS.RETURNED]: [ACTIONS.EDIT, ACTIONS.RESUBMIT],
    [STATUS.RESUBMITTED]: [],
    [STATUS.DOCTOR_PROCESSING]: [],
  ...
  [ROLES.GENERAL_DOCTOR]: {
    [STATUS.DRAFT]: [],
    [STATUS.PENDING_SUBMIT]: [ACTIONS.PROCESS, ACTIONS.RETURN],
    [STATUS.RETURNED]: [],
    [STATUS.RESUBMITTED]: [ACTIONS.PROCESS, ACTIONS.RETURN],
    [STATUS.DOCTOR_PROCESSING]: [],
    [STATUS.DIRECTOR_REVIEW]: [],
    [STATUS.COMPLETED]: [],
    [STATUS.ARCHIVED]: []
  ...
  [ROLES.MEDICAL_DIRECTOR]: {
    ...
    [STATUS.RETURNED]: [],
    [STATUS.RESUBMITTED]: [],
    [STATUS.DOCTOR_PROCESSING]: [ACTIONS.REVIEW, ACTIONS.RETURN],
    [STATUS.DIRECTOR_REVIEW]: [ACTIONS.COMPLETE, ACTIONS.RETURN],
    [STATUS.COMPLETED]: [ACTIONS.ARCHIVE],
    [STATUS.ARCHIVED]: []
  }
}
